...
function () {
  ...
  _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(req) {
    var playlist, creator, username, accessToken, result, dataAll, result2, allUsers, metricsArray;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 15:
            ...
            console.log(typeof dataAll.tracks);
            metricsArray = JSON.parse(dataAll[0].metrics).audio_features;
            console.log(metricsArray[0]); // console.log(dataAll.tracks);
...
//# sourceMappingURL=playlistDisplay.js.b5eb1cbd867cee051913.hot-update.js.map