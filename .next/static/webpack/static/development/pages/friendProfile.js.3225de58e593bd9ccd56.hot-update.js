...
function () {
  ...
  _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(req) {
    var friendUsername, image, topTracks, topArtist, topArtistImage, res, friendData;
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            friendData = _context.sent;
            console.log(friendData[0].image);
            return _context.abrupt("return", {
              data: {
                hi: "hi" // image: dataAll[0].image,
...
//# sourceMappingURL=friendProfile.js.3225de58e593bd9ccd56.hot-update.js.map